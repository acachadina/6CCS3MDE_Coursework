...
public class DotLanguageSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	/**
	 * Contexts:
	 *     RightEdgeDeclaration returns NodeList
	 ...
	 *
	 * Constraint:
	 *     secondNode=[NodeId|ID]
	 */
	protected void sequence_RightEdgeDeclaration(ISerializationContext context, RightEdgeDeclaration semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DotLanguagePackage.Literals.RIGHT_EDGE_DECLARATION__SECOND_NODE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DotLanguagePackage.Literals.RIGHT_EDGE_DECLARATION__SECOND_NODE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getRightEdgeDeclarationAccess().getSecondNodeNodeIdIDTerminalRuleCall_0_0_1(), semanticObject.eGet(DotLanguagePackage.Literals.RIGHT_EDGE_DECLARATION__SECOND_NODE, false));
		feeder.finish();
	}
